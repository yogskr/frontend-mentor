...
export default function Projects() {
  const projectItems = projectListTexts.map((text) => (
    <figure
      key={text.id}
      className={`group flex h-[125px] w-full ${text.backgroundMobile} bg-cover bg-center bg-no-repeat`}
    >
  ...
  return (
    <section className="flex flex-col items-center justify-center gap-10 px-5 pb-20 pt-10 md:px-10 md:pb-28 md:pt-16">
